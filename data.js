...
const T = [
 ...
 {id:'icebreaker',phase:'cadrage',fit:[2,2,2,2,2],goals:['align','process'],triggers:['kickoff','misalign'],dur:0.5},
 {id:'teamcanvas',phase:'cadrage',fit:[2,3,3,3,2],goals:['align','process'],triggers:['kickoff','misalign'],dur:2},
 ...
 {id:'pitch',phase:'strategie',fit:[3,3,3,2,2],goals:['vision','align'],triggers:['kickoff','pivot','growth'],dur:1},
 {id:'remember',phase:'strategie',fit:[2,3,3,2,2],goals:['vision','ideas'],triggers:['pivot','growth','kickoff'],dur:1.5},
 ...
 {id:'eventstorming',phase:'research',fit:[1,2,3,3,3],goals:['users','design','align'],triggers:['refonte','slow','misalign'],dur:3},
 ...
 {id:'altworlds',phase:'ideation',fit:[3,3,3,2,2],goals:['ideas'],triggers:['kickoff','refonte','growth'],dur:1},
 ...
 {id:'radar',phase:'prio',fit:[1,2,3,3,3],goals:['prio','align'],triggers:['backlog','misalign','growth'],dur:1},
 {id:'rice',phase:'prio',fit:[0,1,3,3,3],goals:['prio'],triggers:['backlog'],dur:2},
 {id:'poker',phase:'prio',fit:[0,2,3,3,3],goals:['prio','process'],triggers:['backlog','slow'],dur:1},
 {id:'tshirt',phase:'prio',fit:[1,2,3,3,2],goals:['prio','process'],triggers:['backlog','slow'],dur:1},
 {id:'buyfeature',phase:'prio',fit:[1,2,3,3,3],goals:['prio','align'],triggers:['backlog','misalign','growth'],dur:1.5},
 {id:'refinement',phase:'prio',fit:[0,2,3,3,3],goals:['prio','process'],triggers:['backlog','slow'],dur:1.5},
 {id:'storywriting',phase:'prio',fit:[1,3,3,2,2],goals:['prio','design','process'],triggers:['backlog','slow'],dur:2},
 {id:'dod',phase:'prio',fit:[0,2,3,3,2],goals:['process','align'],triggers:['slow','misalign'],dur:1},
 ...
 {id:'vsm',phase:'alignement',fit:[0,1,2,3,3],goals:['process','measure'],triggers:['slow','backlog'],dur:3},
 {id:'roam',phase:'alignement',fit:[0,1,2,3,3],goals:['align','process'],triggers:['slow','misalign'],dur:1},
 {id:'teamboard',phase:'alignement',fit:[0,1,2,3,3],goals:['align','process'],triggers:['slow','misalign'],dur:2},
