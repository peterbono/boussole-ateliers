...
function indexPage(lang){
  ...
  const desc = lang === 'en' ? '61 product workshops, by phase, with a preview, a how-to and a FigJam board for each.' : '61 ateliers produit, par phase, avec aperçu, déroulé et board FigJam pour chacun.';
