...
const defaultPage = `<!doctype html><html><head><meta charset="utf-8">${css}</head><body><div class="og hero" style="grid-template-columns:1fr"><div><span class="chip" style="--h:222">60+ product workshops · FigJam · free</span><h1>Workshop Compass</h1><p style="max-width:44ch;font-size:26px">The right product workshop, at the right stage, in the right order. Every board ready to run, with a how-to and a filled example.</p></div></div>${brandHtml(I18N.en)}<div class="url">workshop-compass.vercel.app</div></body></html>`;
const jobs = [];
